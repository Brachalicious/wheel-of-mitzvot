...
export const MITZVAH_EXAMPLES: Record<string, string> = {
  ...
  "Love the convert":
    "Even if you never meet a convert, fulfill this mitzvah by: never letting a newcomer stand alone at synagogue, speaking up when someone dismisses Jews-by-choice, and studying the laws of welcoming converts.",
  "Honor your father and mother":
  ...
  "Love the stranger who dwells among you":
    "Check whether your community actively welcomes visitors or makes them feel invisible. If you notice someone sitting alone, go sit near them.",
  "Do not oppress the convert verbally":
    "Never make anyone feel like an outsider because of their background. Stop yourself before any comment that implies someone 'isn't really Jewish.'",
  "Do not harm a convert with words":
    "Build the right habits now: when discussing Jewish identity, never rank 'types' of Jews. Speak up when you hear convert-shaming.",
  "Treat the convert with love":
    "Make your home an explicitly welcoming space — anyone who is newly Jewish should feel at home at your Shabbat table.",
  "Do not cause pain to any living creature (tza'ar ba'alei chayyim)":
    "Be mindful of how your consumer choices affect animal welfare. If you see an animal in distress, don't walk past. Feed an animal before feeding yourself.",
  "Wear tzitzit":
    "Check your tzitzit today to make sure they are intact. Each glance at them throughout the day is meant to remind you of all the mitzvot.",
  "Accept God's complete unity":
    "When you say the Shema, pause at the word 'Echad' (One). Let that unity permeate your understanding — no divisions, no duality.",
  "Fear and revere God":
    "Before your next decision, take a moment to ask: would I be comfortable if God were watching this? That pause is itself yirat Hashem.",
  "Build a fence/guardrail around a roof":
    "Apply the principle of proactive safety: identify one potential hazard in your home or life and address it before it becomes a problem.",
  "Celebrate Purim annually":
    "On Purim: hear the Megillah, give gifts of food to friends, donate to the poor, and eat a festive meal. Joy is itself a mitzvah today.",
  "Remember the Exodus from Egypt daily":
    "Recite the third paragraph of the Shema (which mentions the Exodus) each morning and evening. Let freedom from Egypt inform how you see your own freedom.",
  "Honor Torah scholars":
    "When you encounter a rabbi, teacher, or learned person, show genuine respect. Ask them a Torah question — you honor them by seeking their wisdom.",
  "Teach Torah to others":
    "Share one Torah thought or teaching with someone today. It doesn't need to be formal — a text message with a dvar Torah counts.",
};
...
export function getSefariaUrl(mitzvah: string): string {
  ...
  if (!s) {
    const clean = mitzvah.replace(/^(Do not |Not to |To |The |Observe |Follow |Keep )/i, "").trim();
